...
Ameow 是一个基于 Electron 的轻量桌面素材收集工具，提供常驻桌面的悬浮窗口，用于快速接收文件、图片与网页视频，并把内容统一保存到可控的输出目录。它支持拖拽、粘贴，以及浏览器扩展协同，适合把分散在桌面和浏览器中的素材快速汇总到同一个工作流里。
...
Ameow 通过 GitHub Releases 分发桌面应用与浏览器扩展包。
