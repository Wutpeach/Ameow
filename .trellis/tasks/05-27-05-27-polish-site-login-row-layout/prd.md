...
- Keep the existing site icon, status dot, status label, and compact diagnostics line.
...
- [ ] Diagnostics remain one compact line and truncate instead of stretching the row.
