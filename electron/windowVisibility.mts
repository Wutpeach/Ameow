...
export const STARTUP_DIAGNOSTICS_ARGUMENT = "--ameow-startup-diagnostics";
export const STARTUP_DIAGNOSTICS_ENV = "AMEOW_STARTUP_DIAGNOSTICS";
export const FORCE_OPAQUE_WINDOW_ARGUMENT = "--ameow-force-opaque-window";
export const FORCE_OPAQUE_WINDOW_ENV = "AMEOW_FORCE_OPAQUE_WINDOW";
